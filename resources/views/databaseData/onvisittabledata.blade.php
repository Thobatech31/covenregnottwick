...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class=" ">
        <a id="start"></a>
                                ...
                                <center> <img src="{{asset('externalFolder')}}/img/coven3.png" style="width: 50px; margin-top:-70px;"></center>
            <div class="container-fluid">
                     <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-md-12">
                            <table id="onvisit_table" class="table table-bordered" style="width:120%; margin-left:-10%; background-color:#0EBFE9; color:white"> 
                                <thead> 
                                    <tr> 
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('#onvisit_table').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "ajax": "{{ route('onvisittabledata.fetchData') }}",
                        "columns":[
