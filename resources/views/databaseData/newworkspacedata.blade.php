    ...
    <body class=" ">
        <a id="start"></a>
                            ...
                            <div class="container pos-vertical-center">
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 col-xs-4" style="margin-top:50px; margin-left:-90px;"> 
                                ...
                                <center> <img src="{{asset('externalFolder')}}/img/coven3.png" style="width: 50px; margin-top:-30px;"></center>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-md-12">
                            <table id="newworkspace_table" class="table table-bordered" style="width:120%; margin-left:-10%; background-color:#0EBFE9; color:white"> 
                                <thead> 
                                    <tr> 
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $('#newworkspace_table').DataTable({
                        "processing": true,
                        "serverSide": true,
                        "ajax": "{{ route('newworkspacedata.fetchData') }}",
                        "columns":[
